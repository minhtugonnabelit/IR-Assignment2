...
class RobotGUI:
    ...
    def create_window(self):
        ...
        window = sg.Window('System GUI', tab_group_layout, finalize=True,
                           size=(1368, 768), location=(0, 0), resizable=False)
        return window
    ...
    def tab1_setup(self):
        ...
        tab1_layout = [
            ...
            sg.Text(f'{self.sawyer_controller.system_state()}', size=(15, 1), justification='center', key='-STATE-'),  
    ...
    def gui_updater(self):
        while True:
            ...
            self.window['-JOINT-'].update(value=True)
