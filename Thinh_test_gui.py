...
class RobotGUI:
    ...
    def tab1_setup(self):
        headers = [[
            ...
            sg.Text(f'Rx: {np.rad2deg(self.getori()[0])} deg', size=(15, 1), justification='right', key='-RX-', background_color= 'black'),
            sg.Text(f'Ry: {np.rad2deg(self.getori()[1])} deg', size=(15, 1), justification='right', key='-RY-', background_color= 'black'),
            sg.Text(f'Rz: {np.rad2deg(self.getori()[2])} deg', size=(15, 1), justification='right', key='-RZ-', background_color= 'black'),
        ]]
        ...
        tab1_layout = [
            ...
            [
            sg.Button('Confirm', key='-CONFIRM-', size=(16,3), pad= (8,10)), sg.Button('Home', key='-HOME-', size=(16,3))
            ],
        ]
    ...
    def tab2_setup(self):
        ...
        tab2_layout = [
            [
            sg.Text('ASTORINO CONTROLLER', justification='center',font=('Cooper Black', 24), background_color='black', pad=(10,5)),
            ...
            [sg.Text('Controller state: ', size=(15, 1), justification='right', key='-A_STATE_LABEL-', background_color='black'), 
             sg.Text(f'{self.astorino_controller.system_state()}', size=(15, 1), justification='center', key='-A_STATE-'),
             sg.Button('ENABLE CONTROLLER', key='-A_ENABLE-', size=(30,1), pad=(5,5)),
             sg.Button('Gamepad Mode', size=(15, 1), key='-A_GAMEPAD_ENABLE-' ),
             sg.Button('Disable Gamepad', size=(15, 1), key='-A_GAMEPAD_DISABLE-' ),
             sg.Button('E-stop', button_color=('white', 'red'), size=(30, 1), key='-A_ESTOP-' ),],    
            
            [sg.Text('Joint Space Jogging', key='-A_JS-', font=('Cooper Black', 15), background_color='black', pad=(10,1))],
            ...
            [sg.Text('TCP Jogging', key='-A_TCP-', font=('Cooper Black', 15), background_color='black')],
